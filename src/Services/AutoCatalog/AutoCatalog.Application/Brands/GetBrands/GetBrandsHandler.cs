...
public class GetBrandsQueryHandler(IBrandsRepository brandsRepository)
    : IQueryHandler<GetBrandsQuery, Result<List<Brand>, List<Error>>>
{
    public async Task<Result<List<Brand>, List<Error>>> Handle(GetBrandsQuery query,
