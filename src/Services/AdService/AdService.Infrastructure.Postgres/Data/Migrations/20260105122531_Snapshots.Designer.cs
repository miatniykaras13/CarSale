...
namespace AdService.Infrastructure.Postgres.Data.Migrations
{
    ...
    [Migration("20260105122531_Snapshots")]
                            ...
                            b1.OwnsOne("AdService.Domain.ValueObjects.AutoDriveTypeSnapshot", "DriveType", b2 =>
                                {
                                    ...
                                    b2.Property<Guid>("CarSnapshotCarId")
                                        .HasColumnType("uuid");
                                    ...
                                    b2.HasKey("CarSnapshotAdId", "CarSnapshotCarId");

                                    b2.ToTable("CarSnapshots");

                                    b2.WithOwner()
                                        .HasForeignKey("CarSnapshotAdId", "CarSnapshotCarId");
                                });
                                    ...
                                    b2.OwnsOne("AdService.Domain.ValueObjects.FuelTypeSnapshot", "FuelType", b3 =>
                                        {
                                            ...
                                            b3.Property<Guid>("EngineSnapshotCarSnapshotCarId")
                                                .HasColumnType("uuid");
                                            ...
                                            b3.HasKey("EngineSnapshotCarSnapshotAdId", "EngineSnapshotCarSnapshotCarId");

                                            b3.ToTable("CarSnapshots");

                                            b3.WithOwner()
                                                .HasForeignKey("EngineSnapshotCarSnapshotAdId", "EngineSnapshotCarSnapshotCarId");
                                        });
