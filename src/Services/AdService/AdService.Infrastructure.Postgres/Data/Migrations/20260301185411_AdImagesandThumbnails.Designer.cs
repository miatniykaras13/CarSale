...
namespace AdService.Infrastructure.Postgres.Data.Migrations
{
    ...
    [Migration("20260301185411_AdImagesandThumbnails")]
    partial class AdImagesandThumbnails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdService.Domain.Aggregates.Ad", b =>
                {
                    b.OwnsMany("AdService.Domain.ValueObjects.AdImage", "Images", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uuid");
                            ...
                            b1.OwnsMany("AdService.Domain.ValueObjects.Thumbnail", "Thumbnails", b2 =>
                                {
                                    b2.Property<Guid>("AdImageId")
                                        .HasColumnType("uuid");

                                    b2.Property<Guid>("AdImageAdId")
                                        .HasColumnType("uuid");
                                    ...
                                    b2.HasKey("AdImageId", "AdImageAdId", "Id");

                                    b2.ToTable("AdImageThumbnails", (string)null);

                                    b2.WithOwner("AdImage")
                                        .HasForeignKey("AdImageId", "AdImageAdId");

                                    b2.Navigation("AdImage");
                                });
